...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'mostafizur15-13849@diu.edu.bd' ")
...
frame2 = tk.Frame(window, bg="#121212")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Smart Attendance System" ,fg="white",bg="#262523" ,width=48 ,height=1,font=('times', 32, ' bold '))
...
lbl = tk.Label(frame2, text="Enter Your DIU ID",width=20  ,height=1  ,fg="white"  ,bg="#141414" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="white"  ,bg="#141414" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#121212" ,fg="white"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#121212" ,fg="yellow"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="white"  ,bg="#121212"  ,height=1 ,font=('times', 17, ' bold '))
